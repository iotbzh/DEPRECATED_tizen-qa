...
part / --fstype="ext4" --ondisk=sda --size=4200 --active --label tizen-pc-trunk
...
repo --cost=5 --name=trunk_pc --baseurl=@REPO_URL@/repos/pc/x86_64/packages --ssl_verify=no
repo --cost=5 --name=google --baseurl=@TZ_URL@/pc/repos/google --ssl_verify=no
...
echo "@IMAGETAG@ @SNAPSHOT@ wrt" >/etc/tizen-snapshot
